              ...
              <div className="">
                <div className="flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                  <div className="flex flex-col justify-start items-start w-full space-y-2 md:space-y-2 xl:space-y-4">
                    {[1, 2, 3].map((el) => (
                      <div
                        className="flex flex-col justify-start items-start bg-white rounded-xl px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full"
                        key={el}
                      >
                        <div className="mt-4 py-6 px-6 md:mt-6 flex flex-col md:flex-row hover:shadow-2xl hover:scale-105 transition-all transform duration-500 justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
